...
for index=1:10
    SVMModel{index} = fitcsvm(train_Feat,trainingClassLabelsMatrix(index,:),'KernelFunction','polynomial','PolynomialOrder',3);
end
...
[TP,TN,FP,FN,accuracy,sensitivity,specificity,f_score] = deal(zeros(numOfClasses,1));
